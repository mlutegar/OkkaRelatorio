...
SECRET_KEY = 'django-insecure-##5&bo(z3!wsbm6#d*b*d*c566b6$&s&@k%j5&u#87)w1_l^gz'
...
CSRF_TRUSTED_ORIGINS = [
    "https://okkarelatorio.fly.dev",
    "http://okkarelatorio.fly.dev",
    'http://127.0.0.1:3005',
    'http://127.0.0.1:3000',
    'http://localhost:3000',
    'http://localhost:3005',
    "http://localhost:8000",  # Seu servidor de desenvolvimento Django
...
ROOT_URLCONF = 'OkkaRelatorio.urls'
